...
const char PUBLISH_TOPIC[] = "iot/chompoo";       // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "iot/chompoo";  // CHANGE IT AS YOU DESIRE

const int PUBLISH_INTERVAL = 4000;  // 5 seconds
