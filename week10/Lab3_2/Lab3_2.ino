...
const char WIFI_SSID[] = "NoInternet";     // CHANGE TO YOUR WIFI SSID
const char WIFI_PASSWORD[] = "12345678pan";  // CHANGE TO YOUR WIFI PASSWORD
...
const char MQTT_CLIENT_ID[] = "64070215-iot";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";              // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";              // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "iot/64070215";       // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "iot/64070215";  // CHANGE IT AS YOU DESIRE
...
void messageHandler(String &topic, String &payload) {
  ...
  } else if (payload.toInt() >= 0 && payload.toInt() <= 255) {
